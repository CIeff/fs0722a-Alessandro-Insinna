...
let artista=document.querySelector("#titolo-album");
artista.innerHTML=def3.data[0].artist.name;
    ...
    for (let x=0;x<=4;x++){
       ...
       let provaTesto= document.querySelector("#testo-nav");
       provaTesto.innerHTML=`${scelta.album.title}`;
            loadPlayer(scelta);
