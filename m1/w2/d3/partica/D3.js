...
/* ESERCIZIO 5
  ...
  del carrello dell'utente in una variabile "totalShoppingCart".
  C'è una promozione in corso: se il totale del carrello supera 50, 
  l'utente ha diritto alla spedizione gratuita (altrimenti 
...
/* ESERCIZIO 6
  ...
  determinando come prima se le spedizioni sono gratuite oppure no e e 
...
/* ESERCIZIO 9
  ...
  sia pari o dispari (suggerimento: cerca l'operatore modulo su
...
/* ESERCIZIO 11
  Fornito il seguente oggetto, 
  scrivi del codice per aggiungere una proprietà "city", 
...
/* function inserisciVariabile()
{
    let var1=prompt("inserisci variabile");
    ...
    let tot=var1+1>0? "typeof = number" : "typeof = not a number";
    console.log(tot);
